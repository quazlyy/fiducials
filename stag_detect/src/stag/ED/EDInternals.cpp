...
///
static void ComputeAnchorPoints(short *gradImg, unsigned char *dirImg, EdgeMap *map,
                                int GRADIENT_THRESH, int ANCHOR_THRESH, int SCAN_INTERVAL) {
    int width = map->width;
...
///
/// static
void JoinAnchorPointsUsingSortedAnchors(short *gradImg, unsigned char *dirImg, EdgeMap *map,
...
// ///
// int EDWalk(short *gradImg, EdgeMap *map, int GRADIENT_THRESH, int r, int c, int dir, Pixel
// *pixels){
//   unsigned char *edgeImg = map->edgeImg;

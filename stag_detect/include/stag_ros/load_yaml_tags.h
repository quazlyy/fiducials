...
inline std::vector<Tag> parseTags(XmlRpc::XmlRpcValue &tags_xml) {
    std::vector<Tag> tags;
...
inline std::vector<Bundle> parseBundles(XmlRpc::XmlRpcValue &bundles_xml) {
...
inline void loadTagsBundles(const ros::NodeHandle &nh_lcl, const std::string &tag_name,
                            const std::string &bundle_name, std::vector<Tag> &tags,
                            std::vector<Bundle> &bundles) {

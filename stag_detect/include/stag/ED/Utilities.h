...
void RGB2LabDeneme(unsigned char *redImg, unsigned char *greenImg, unsigned char *blueImg,
                   unsigned char *LImg, unsigned char *aImg, unsigned char *bImg, int width,
                   int height);
...
void RGB2Lab2(unsigned char *redImg, unsigned char *greenImg, unsigned char *blueImg,
              unsigned char *LImg, unsigned char *aImg, unsigned char *bImg, int width, int height);

void StdRGB2Lab(unsigned char *redImg, unsigned char *greenImg, unsigned char *blueImg,
                unsigned char *LImg, unsigned char *aImg, unsigned char *bImg, int width,
                int height);

void StdRGB2LabOne(unsigned char r, unsigned char g, unsigned char bl, double *L, double *a,
                   double *b);
...
void RGB2Luv(unsigned char *redImg, unsigned char *greenImg, unsigned char *blueImg,
             unsigned char *LImg, unsigned char *uImg, unsigned char *vImg, int width, int height);

void RGB2HSL(unsigned char *redImg, unsigned char *greenImg, unsigned char *blueImg,
             unsigned char *HImg, unsigned char *SImg, unsigned char *LImg, int width, int height);

void RGB2YUV(unsigned char *redImg, unsigned char *greenImg, unsigned char *blueImg,
             unsigned char *YImg, unsigned char *UImg, unsigned char *VImg, int width, int height);
...
unsigned char *ScaleImage(unsigned char *srcImg, int width, int height, double scale, int *pw,
                          int *ph);
